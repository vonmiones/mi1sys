            ...
            <div role="tabpanel" class="tab-pane fade show active" id="tab-1">
                <div class="d-xl-flex flex-fill form-container">
                    <form class="flex-fill" method="post" style="max-width: 700px;margin: 0 auto;">
                        ...
                        <div class="form-group d-md-flex justify-content-md-center"><input type="text" class="form-control" placeholder="Last Name" name="lastname" style="border-style: none;border-bottom: 1px solid var(--blue) ;" /><input type="text" class="form-control-plaintext" value=", " readonly style="max-width: 5px;" /><input type="text" class="form-control" placeholder="First Name" name="firstname" style="border-style: none;border-bottom: 1px solid var(--blue) ;" /><input type="text" class="form-control-plaintext" value=", " readonly style="max-width: 5px;" /><input type="text" class="form-control" placeholder="Middle Name" name="middlename" style="border-style: none;border-bottom: 1px solid var(--blue) ;" /><input type="text" class="form-control-plaintext" value=", " readonly style="max-width: 5px;" /><select class="form-control" name="namesuffix" style="border-style: none;border-bottom: 1px solid var(--blue) ;">
                        ...
                        <div class="form-group text-center text-sm-center text-md-center text-lg-center text-xl-center d-md-flex d-xl-flex justify-content-md-center justify-content-xl-center align-items-xl-center">
                            <div class="custom-control custom-control-inline custom-radio" style="margin: 5;"><input type="radio" class="custom-control-input" id="formCheck-1" name="rdgender" style="margin: 5;" /><label class="custom-control-label" for="formCheck-1" style="margin: 5;">MALE</label></div>
                            <div class="custom-control custom-control-inline custom-radio" style="margin: 5;"><input type="radio" class="custom-control-input" id="formCheck-2" name="rdgender" /><label class="custom-control-label" for="formCheck-2">FEMALE</label></div>
                            <div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input" id="formCheck-3" /><label class="custom-control-label" for="formCheck-3" style="margin-right: 10px;">Person With Disability</label></div>
                            <div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input" id="formCheck-4" /><label class="custom-control-label" for="formCheck-4">IP member<br /></label></div>
                            <section></section>
                        </div>
                        <div class="form-group"><label>Birth Date</label><input class="form-control" type="date" name="birthdate" style="border-style: none;border-bottom: 1px solid var(--blue) ;" /></div>
                        <section>
                            <div class="form-group d-md-flex" style="padding: 20px;background: rgb(244,244,244);"><label style="margin-right: 5;margin-left: 10px;min-width: 200px;">Valid ID Type<select class="form-control">
                                    ...
                                    </select></label><label style="margin-right: 10px;margin-left: 10px;min-width: 200px;">Valid ID Detail<input type="text" class="form-control" style="margin-right: 10px;margin-left: 10px;" placeholder="ID Number, Code, Serial" /></label><label style="margin-right: 10px;margin-left: 10px;min-width: 300px;">ID Attachment<input type="file" class="form-control-file" required /></label></div>
                        </section>
                    </form>
                </div>
            </div>
            <div role="tabpanel" class="tab-pane fade" id="tab-2">
                <form style="margin-top: 20px;">
                    <fieldset class="d-md-flex justify-content-md-center">
                        ...
                        <div class="form-group d-flex align-content-center justify-content-xl-center" style="border-bottom-width: 1px;border-bottom-color: var(--blue);"><input type="text" class="form-control" id="telno" placeholder="Telephone Number (required)" name="contactnumber" required style="margin: 5px;border-width: 0;border-bottom-width: 1px;border-bottom-color: var(--blue);min-width: 250px;" minlength="5" maxlength="15" /><input type="text" class="form-control" id="contno" placeholder="Mobile Number (required)" name="contactnumber" required style="margin: 5px;border-width: 0;border-bottom-width: 1px;border-bottom-color: var(--blue);min-width: 250px;" minlength="5" maxlength="15" /><input type="email" class="form-control" id="contno-1" placeholder="Email (optional)" name="email" required style="margin: 5px;border-width: 0;border-bottom-width: 1px;border-bottom-color: var(--blue);min-width: 250px;" minlength="5" maxlength="11" /></div>
                    </fieldset>
                    <fieldset>
                        <legend style="color: var(--blue);border-bottom-width: 1px;border-bottom-color: var(--blue);">Address</legend>
                        <div class="custom-control custom-switch" style="margin: 10px;"><input type="checkbox" class="custom-control-input" id="formCheck-5" /><label class="custom-control-label" for="formCheck-5">Permanent Address</label></div>
