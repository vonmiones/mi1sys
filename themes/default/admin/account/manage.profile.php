                    ...
                    <form action="#" class="comment-area-box mb-3">
                        ...
                        <div class="comment-area-btn">
                            <div class="float-end">
                                ...
                                <a href="#" class="btn btn-sm btn-light text-black-50"><i class="fad fa-user"></i></a>
                                <a href="#" class="btn btn-sm btn-light text-black-50"><i class="fad fa-map-marker-alt"></i></a>
                                <a href="#" class="btn btn-sm btn-light text-black-50"><i class="fad fa-camera"></i></a>
                                <a href="#" class="btn btn-sm btn-light text-black-50"><i class="fad fa-smile"></i></a>
