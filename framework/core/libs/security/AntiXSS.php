 ...
 * @version : v1.2 (Beta)
 * @license : GNU License v2.0 http://www.gnu.org/licenses/gpl-2.0.html
...
class AntiXSS {
     ...
     */
    function setEncoding($str, $newEncoding) {
     ...
     */
    function whitelistFilter($str, $whiteFilterPattern) {
     ...
     */
    function setFilter($str, $filterMethod, $filterPattern = NULL, $noHTMLTag = NULL) {
