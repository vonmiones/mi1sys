            ...
            <section>
                ...
                <div style="float:left;" class="list-containers">                
                    <fieldset>
                        <legend>Apps</legend>
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center"><span> <input type="checkbox" name="apps[]" value=""> Blocked</span> <span class="badge badge-primary badge-pill">14</span></li>
                        </ul>
                    </fieldset>
                </div>
            </section>
