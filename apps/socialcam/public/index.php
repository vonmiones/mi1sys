            ...
            <div class="form-control form-group">          
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-3">
                        <input class="input-switch" type="radio" name="sensitivity" value="30" > Alternative
                    </label>
                    <label class="col-md-3">
                        <input class="input-switch" type="radio" name="sensitivity" value="55" > Familiar
                    </label>
                    <label class="col-md-3">
                        <input class="input-switch" type="radio" name="sensitivity" value="75" checked=""> Precise
                    </label>
                </div>
            </div>
            <center>
            ...
            <div class="wrapper tick-wrapper">
                ...
                <center>
                    <div id="ticker" class="tick"
                         data-value="0"
                         data-did-init="setupFlip" data-transform="arrive(10, .1) -> round -> pad(0000) -> split -> delay(random, 100, 150)">
...
<div class="container">
    <div class="row">    
        <table id="validatedlist" class="display" style="width:100%">
            <thead>
                <tr>
                    <th>Payroll</th>
                    <th>Full Name</th>
...
<script>
   $(document).ready(function() {
    ...
    function drawNames(){
         $("#toolbox").load( "?form=form.draw", function() {
            $('.modal').modal('show');
       });
    }
    ...
    $("#raffleBtn").click(function(event) {
         drawNames();
    });
